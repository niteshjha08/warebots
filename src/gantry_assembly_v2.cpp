...
#include <ros/ros.h>
#include "gantry_assembly_v2.h"
#include "gantry_assembly_v2/Attach.h"
#include "gantry_assembly_v2/AttachRequest.h"
#include "gantry_assembly_v2/AttachResponse.h"
...
namespace gazebo
{
  ...
  bool GazeboRosLinkAttacher::attach_callback(gantry_assembly_v2::Attach::Request &req,
                                              gantry_assembly_v2::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(gantry_assembly_v2::Attach::Request &req,
                                              gantry_assembly_v2::Attach::Response &res){
