...
if __name__=="__main__":
    ...
    rospy.init_node('second_gantry_teleop')
    ...
    pub_h_slider = rospy.Publisher('/second_gantry_group/controller_h_slider/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_v_slider = rospy.Publisher('/second_gantry_group/controller_v_slider/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
    pub_gripper1 = rospy.Publisher('/second_gantry_group/controller_joint1_gripper/command', Float64, queue_size=10)
    pub_gripper2 = rospy.Publisher('/second_gantry_group/controller_joint2_gripper/command', Float64, queue_size=10)
